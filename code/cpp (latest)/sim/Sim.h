...
public:
        ...
        void TimeStep(string& first, string& second, string& third, string& household, string& k12school, string& college, string& workplace, string& primary, string& secondary, string& cluster, bool measure, std::mt19937& mt_gen);
