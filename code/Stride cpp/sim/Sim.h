...
public:
        ...
        void TimeStep(string& first, string& second, string& third, string& total,
                string& household, string& k12school, string& college, string& workplace, string& primary, string& secondary, string& cluster,
